...
namespace GPUInstancer.CrowdAnimations
{
    public static class GPUICrowdConstants
    {
        ...
        public static readonly string SHADER_GPUI_CROWD_TEST_HDRP = "GPUInstancer/CrowdAnimations/HDRP/Crowd_Animations_Test_SG";
        ...
        public static readonly string SHADER_GPUI_CROWD_TEST_URP = "GPUInstancer/CrowdAnimations/Universal Render Pipeline/Crowd_Animations_Test_SG";
#else
