...
namespace GPUInstancer.CrowdAnimations
{
    public class GPUICrowdAnimationBaker
    {
        ...
        public void AnimationBakerStart()
        {
            try
            {
                if (EditorUtility.DisplayCancelableProgressBar("GPU Instancer Animaton Baker", "Baking animations for GPUI...", 0.1f))
                {
                    ClearBakingData();
                    return;
                }
                ...
                foreach (AnimationClip animationClip in _animationBakeData.crowdPrototype.clipList)
                {
                    ...
                    GPUIAnimationClipData acd = new GPUIAnimationClipData
                    {
                        ...
                        isClipLooping = animationClip.isLooping
                    };
        ...
        public void AnimationBakerUpdate()
        {
            ...
            try
            {
                ...
                if (EditorUtility.DisplayCancelableProgressBar("GPU Instancer Animaton Baker", "Frame No: " + _animationBakeData.currentClipFrame + "/" + animationClipData.clipFrameCount
                ...
                {
                    hasMotion = motionMatrix != Matrix4x4.identity,
                    isPositionOnly = _animationBakeData.sampleObject.transform.rotation == Quaternion.identity,
