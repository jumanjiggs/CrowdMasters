// GPUInstancer enabled version of Unity built-in shader "Standard (Specular setup)"

Shader "GPUInstancer/CrowdAnimations/Standard (Specular setup)"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass {
			...
			#include "Include/GPUICrowdStandardShadowInclude.cginc"
