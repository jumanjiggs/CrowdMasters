...
#if UNITY_STANDARD_SIMPLE
    VertexOutputForwardBase vertBaseGPUI (appdata_full v) { return vertForwardBaseGPUI(v); }
    VertexOutputForwardAdd vertAddGPUI (appdata_full v) { return vertForwardAddGPUI(v); }
