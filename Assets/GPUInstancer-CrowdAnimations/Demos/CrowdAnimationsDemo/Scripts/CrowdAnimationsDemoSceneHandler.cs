...
namespace GPUInstancer.CrowdAnimations
{
    ...
    public class CrowdAnimationsDemoSceneHandler : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            _parentTranform = (new GameObject("Crowd Instances")).transform;
            ...
            for (int r = 0; r < _rowCount; r++)
            {
                for (int c = 0; c < _collumnCount; c++)
                {
                    ...
                    GameObject instanceGO = Instantiate(prefabObject, pos, rotation, _parentTranform);
                    instanceList.Add(instanceGO.GetComponent<GPUICrowdPrefab>());
                }
            }
            
            // Register the instantiated GOs to the Crowd Manager
            GPUInstancerAPI.RegisterPrefabInstanceList(gpuiCrowdManager, instanceList);
        ...
        public void SwitchProtoype()
        {
            ...
            Destroy(_parentTranform.gameObject);
            _rowCount = 30;
            _collumnCount = 30;
